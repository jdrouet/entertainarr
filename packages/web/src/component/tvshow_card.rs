            ...
            <div class="p-4 flex-1">
                ...
                <div class="flex gap-2 mt-1 text-xs">
                    if show.following {
                        ...
                        if show.watch_completed() {
                            <span class="bg-green-100 text-green-800 px-2 py-0.5 rounded-full">{"Completed"}</span>
                        } else {
                            <span class="bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full">{format!("Progress {}%", show.watched_episode_count * 100 / show.episode_count)}</span>
                        }
                    }
                    if show.terminated {
