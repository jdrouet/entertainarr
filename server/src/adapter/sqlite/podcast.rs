...
impl crate::domain::podcast::prelude::PodcastRepository for super::Pool {
    #[tracing::instrument(
        skip_all,
        fields(
            otel.kind = "client",
...
impl crate::domain::podcast::prelude::PodcastSubscriptionRepository for super::Pool {
    #[tracing::instrument(
        skip_all,
        fields(
            otel.kind = "client",
    ...
    async fn list(
        &self,
        user_id: u64,
    ) -> anyhow::Result<Vec<crate::domain::podcast::entity::Podcast>> {
