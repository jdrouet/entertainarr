...
use crate::domain::podcast::entity::{Podcast, PodcastEpisode, PodcastWithEpisodes};

impl TryFrom<super::ChannelItem> for PodcastEpisode {
...
impl TryFrom<super::Channel> for PodcastWithEpisodes {
    type Error = anyhow::Error;
...
impl crate::domain::podcast::prelude::RssFeedLoader for super::RssClient {
    ...
    async fn load(&self, feed_url: &str) -> anyhow::Result<PodcastWithEpisodes> {
        let res = self
            .client
            .get(feed_url)
            .send()
        ...
        PodcastWithEpisodes::try_from(channel)
    }
}
